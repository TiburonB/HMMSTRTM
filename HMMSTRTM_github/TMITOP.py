...
Helix_emission =  [ 0.1, 0.01, 0.01, .01, 0.01, 0.83, 0.01, 0.01, 0.01, 0 ]
...
distribution = get_period(data_dict, 'TMSEQ', 'I')
#view_np(distribution,'TMH_periodicity', './', QUIET = False)
make_TM_I_region(CANON, node_data, distribution)

CANON.AA_EPS = 0.00001
CANON.SS_EPS = 0.00001
CANON.TM_EPS = 0.00000000001
CANON.RAMA_EPS = 0.00000001
CANON.write('./TMITOP/HMMSTRTM.hmm')
CANON = hmm('HMMSTRTM.hmm', directory = './TMITOP/')
CANON.read()
display(CANON)
