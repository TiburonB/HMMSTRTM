...
distribution = get_period(data_dict, 'TMSEQ', 'H')
#view_np(distribution,'TMH_periodicity', './', QUIET = False, nf = max(distribution)-min(distribution))
#raise
make_TM_region(CANON,"H", node_data, distribution)

CANON.AA_EPS = 0.00001
CANON.SS_EPS = 0.00001
CANON.TM_EPS = 0.00000000001
CANON.RAMA_EPS = 0.00000001
CANON.write('./JAN3/HMMSTRTM.hmm')
CANON = hmm('HMMSTRTM.hmm', directory = './JAN3/')
CANON.read()
display(CANON)
